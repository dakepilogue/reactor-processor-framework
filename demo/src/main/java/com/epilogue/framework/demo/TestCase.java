...
import com.epilogue.framework.processor.ProcessorFramework;
...
public class TestCase {
    ...
    public static void main(String[] args) {
        ...
        processorFramework.process(new TestRequest(), dummyHandler)
            ...
            .block();
        // 调用processWithInfo接口
        Tuple2<Object, ProcessInfo> tuple2 = processorFramework
            ...
            .block();
        log.info(tuple2.getT2().getTimeInfo().toString());
