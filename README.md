...
myProcessor = ${basic}{
  class = com.epilogue.framework.processor.core.MyProcessor
...
serial_practice = ${serial}{
  children = [
    ...
    ${basic}{
      class = com.epilogue.framework.processor.core.OtherProcessor
    }
    ${basic}{
      class = com.epilogue.framework.processor.core.AnotherProcessor
    }
  ]
}
```
...
parallel_practice = ${parallel}{
  ...
  merger = ${basic}{  # 覆盖parallel中的默认值merger(BasicMerger)
    class = com.epilogue.framework.processor.core.MyMerger
  }
}
```
...
switch_practice = ${switch}{
  condition = ${basic}{class = com.epilogue.framework.processor.core.MyCondition}  # 只能返回valueA或valueB，否则抛异常
  cases = {
    valueA = ${myProcessor}  # 引用processor_practice.conf里面的processor定义
    valueB = ${basic}{
      class = com.epilogue.framework.processor.core.CaseBProcessor
    }
  }
}
```
...
switch_practice = ${switch}{
  selector = ${basic}{class = com.epilogue.framework.processor.core.MySelector}  # 只能返回valueA、valueB和valueC的集合，否则抛异常
  subChain = {
    valueA = ${myProcessor}  # 引用processor_practice.conf里面的processor定义
    valueB = ${basic}{
      class = com.epilogue.framework.processor.core.ChainBProcessor
    }
    valueC = ${basic}{
      class = com.epilogue.framework.processor.core.ChainCProcessor
    }
  }
  merger = ${basic}{  # 覆盖parallel中的默认值merger(BasicMerger)
    class = com.epilogue.framework.processor.core.MyMerger
...
practice = ${serial}{
  children = [
    ...
    ${basic}{
      class = com.epilogue.framework.processor.render.DummyRender
    }
  ]
}
```
...
public class CaseTest {
    ...
    public void practice() {
        ...
        // 调用process接口
        Mono<Object> flux = processorFramework.process(new TestContext(), handlerConfig);
        // ...后续处理
    }
